...
export function DocumentsPage() {
  ...
  return (
    <div>
      <PageHeader title="Documentos" subtitle="Almacenamiento de evidencia vinculado a la inteligencia del proveedor" action={suppliers && suppliers.length > 0 ? <Button onClick={openCreate}><Plus size={16} /> Add Document</Button> : undefined} />
