...
export function ProductsPage() {
  ...
  return (
    <div>
      <PageHeader title="Productos" subtitle="Familias de productos en español, agrupadas por proveedor para evitar duplicaciones." action={suppliers && suppliers.length > 0 ? <Button onClick={openCrear}><Plus size={16} /> Agregar producto</Button> : undefined} />
